export default {
  ...
  imageCenter: {
    title: 'Image Center',
    description: 'Submit image tasks and review results from the last 24 hours',
    ...
    clear: 'Clear',
    required: 'Please fill API key, model, and prompt',
    imageRequired: 'Please choose at least one input image',
    submit: 'Submit Task',
    submitting: 'Submitting...',
    refresh: 'Refresh',
    tasks: 'Tasks',
